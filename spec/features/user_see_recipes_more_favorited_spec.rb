...
feature 'user see more favorite recipes' do
  scenario 'successfully' do
    ...
    create(:favorite, user: user, recipe: recipe2)
    create(:favorite, user: user2, recipe: recipe2)
    create(:favorite, user: user3, recipe: recipe2)
    create(:favorite, user: user, recipe: recipe)
    create(:favorite, user: user2, recipe: recipe)
    create(:favorite, user: user3, recipe: recipe3)
    create(:favorite, user: user, recipe: recipe3)
    create(:favorite, user: user3, recipe: recipe4)
