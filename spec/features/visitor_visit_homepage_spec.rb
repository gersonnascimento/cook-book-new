...
feature 'Visitor visit homepage' do
  ...
  scenario 'and view recipes list' do
    ...
    recipe = create(:recipe, title: 'Bolo de cenoura', difficulty: 'Médio',
                             ...
                             cook_time: 60, cuisine: cuisine,
                             recipe_type: recipe_type)

    user = create(:user, email: 'bonecojosias@locaweb.com.br',
                         password: '123456')
    ...
    another_recipe = create(:recipe, title: 'Feijoada', difficulty: 'Difícil',
                                     ...
                                     method: 'Cozinhar o feijao e refogar',
                                     cook_time: 90, cuisine: another_cuisine,
  ...
  scenario 'view only 6 last recipes' do
    ...
    cuisine = create(:cuisine)
    recipe_type = create(:recipe_type)
    recipe1 = create(:recipe, cuisine: cuisine, recipe_type: recipe_type,
                              user: user)
    recipe2 = create(:recipe, cuisine: cuisine, recipe_type: recipe_type,
                              user: user)
    recipe3 = create(:recipe, cuisine: cuisine, recipe_type: recipe_type,
                              user: user)
    recipe4 = create(:recipe, cuisine: cuisine, recipe_type: recipe_type,
                              user: user)
    recipe5 = create(:recipe, cuisine: cuisine, recipe_type: recipe_type,
                              user: user)
    recipe6 = create(:recipe, cuisine: cuisine, recipe_type: recipe_type,
                              user: user)
    recipe7 = create(:recipe, cuisine: cuisine, recipe_type: recipe_type,
                              user: user)
